...
{
    public class PulumiDestroyTests
    {
        private class Fixture : PulumiFixture<PulumiDestroySettings>
        {
            ...
            {
                var tool = new PulumiDestroyRunner(FileSystem, Environment, ProcessRunner, Tools);
                tool.Run(Settings);
            }
        }
