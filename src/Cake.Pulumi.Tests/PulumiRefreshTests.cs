...
{
    public class PulumiRefreshTests
    {
        private class Fixture : PulumiFixture<PulumiRefreshSettings>
        {
            ...
            {
                var tool = new PulumiRefreshRunner(FileSystem, Environment, ProcessRunner, Tools);
                tool.Run(Settings);
            }
        }
