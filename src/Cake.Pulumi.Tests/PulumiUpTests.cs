...
{
    public class PulumiUpTests
    {
        private class Fixture : PulumiFixture<PulumiUpSettings>
        {
            ...
            {
                var tool = new PulumiUpRunner(FileSystem, Environment, ProcessRunner, Tools);
                tool.Run(Settings);
            }
        }
        ...
        public class TheExecutable
        {
            ...
            public void Should_set_apply_parameter()
            {
                ...
                Assert.Contains("up", result.Args);
            }

            [Fact]
            public void Should_set_refresh()
            {
                var fixture = new Fixture
                {
                    Settings = new PulumiUpSettings
